...
class InitialCond :
    def __init__(self, nb_grid, mode = "simple", fctn = None, area_init = [30, 50]) :
        if nb_grid == "ARO" : 
        ...
        self.data = xr.Dataset(data_vars={}, coords = {"level" : self.vertical_levels_grid})
        ...
        self.data["concentration"] = concentration_profile

initial_conds = InitialCond(nb_grid = 50)
print (initial_conds.vertical_levels_grid)
print (initial_conds.data)
print (initial_conds.data["concentration"])
