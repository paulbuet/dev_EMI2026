...
class Model_bl():
   ...
   def __init__(self, type_advance,number_stitches,deformable):
        ...
        """
        grid is in the form of a numpy array of size nb_mesh*variables:

        mesh_number: 0  1  2  3  ...
        height of upper mesh interfaces: Z0  Z1  Z2  Z3  ...
        number of particles with diameter 1: N0(1)  N1(1)  N2 (1)  N3(1) ...
        diameter size 1: D1  D1  D1  D1 ...
        ...
        number of particles with diameter n: N0(n)  N1(n)  N2(n)  N3(n) ...
        diameter size n: Dn  Dn  Dn  Dn ...
        
        """
   
        condi_init = Initial_Cond(self.number_stitches)
   
        self.grid = condi_init.grid()
