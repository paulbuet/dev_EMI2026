...
from Semi_lagrangien import Model_sl
"""
...
class distribution:
    def __init__(self,model,type_advance,number_stitches,deformable,number_bin,number_particules,time_step,speed_max,esp,CFL, efficiency_test, type_init, lenght_sim):
        if efficiency_test == "Yes" : 
            ...
            if model == "Box_Lagrangien":
                if type_advance == "Step_By_Step":                    
                    if deformable == "No":     #  Par défaut on arrive ici.
                        ...
                        model_config = Model_bl_def(number_stitches,time_step,number_particules,speed_max,esp,CFL, lenght_sim)
            ...
            elif model == "Semi_Lagrangien" :
                
                if deformable == "No" :
                    
                    model_config = Model_sl(number_stitches,time_step,number_particules,speed_max,esp,CFL, lenght_sim)
                    ...
                    sys.exit("Pas de modèle déformable pour le Semi Lagrangien")
